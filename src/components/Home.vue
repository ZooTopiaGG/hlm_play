<template>
  ...
  <div class="home margin">
    <el-form ref="form" :model="form" label-width="100px" :rules="rules">
      ...
      <el-form-item label="宣传图片" v-loading.body="loadingAvatarUpload">
        <el-col :span="6" class='backgroundImg'>
          <img :src="form.addImgSrc">
        </el-col>
        <el-col :span="14" class="rightBtn">
          <el-button type="warning">添加海报</el-button>
          <p class="prompt">温馨提示：图片尺寸建议为900*525，图片须小于4M</p>
      ...
      <el-form-item label="上课时间" required >
        <el-col :span="4">
          <el-form-item prop="date1">
            <el-date-picker type="date" :picker-options="form.pickerOptions0" placeholder="开始日期" v-model="form.date1" style="width: 150px;"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col class="line" :span="1">-</el-col>
        <el-col :span="4">
          <el-form-item prop="date2">
            <el-date-picker type="date" :picker-options="form.pickerOptions0" placeholder="结束日期" v-model="form.date2" style="width: 150px;"></el-date-picker>
          </el-form-item>
        </el-col>
            ...
            <div class="boxes flex">
              ...
              <div class="checkList flex-1">
                <div class="week1" ref="week1">
                  <el-checkbox v-for="(item, index) in checkedSchedule[0]" :key="Math.random()+index" @change="changeWeek(index, 1)">
                  </el-checkbox>
                </div>
                <div class="week2" ref="week2">
                   <el-checkbox v-for="(item, index) in checkedSchedule[1]" :key="Math.random()+index" @change="changeWeek(index, 2)">
                  </el-checkbox>
                </div>
                <div class="week3" ref="week3">
                   <el-checkbox v-for="(item, index) in checkedSchedule[2]" :key="Math.random()+index" @change="changeWeek(index, 3)">
                  </el-checkbox>
                 
                </div>
                <div class="week4" ref="week4">
                   <el-checkbox v-for="(item, index) in checkedSchedule[3]" :key="Math.random()+index" @change="changeWeek(index, 4)">
                  </el-checkbox>
                </div>
                <div class="week5" ref="week5">
                   <el-checkbox v-for="(item, index) in checkedSchedule[4]" :key="Math.random()+index" @change="changeWeek(index, 5)">
                  </el-checkbox>
                </div>
                <div class="week6" ref="week6">
                   <el-checkbox v-for="(item, index) in checkedSchedule[5]" :key="Math.random()+index" @change="changeWeek(index, 6)">
                  </el-checkbox>
                </div>
                <div class="week7" ref="week7">
                   <el-checkbox v-for="(item, index) in checkedSchedule[6]" :key="Math.random()+index" @change="changeWeek(index, 7)">
                  </el-checkbox>
                </div>
              </div>
            </div>
          ...
          <div v-show="form.isSign">
            <el-col :span="4">
              <el-form-item prop="date3">
                <el-date-picker type="date" placeholder="截止日期" v-model="form.date3" style="width: 150px;"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col class="line" :span="1">-</el-col>
            <el-col :span="4">
      ...
      <el-form-item label="年龄阶段" required>
        ...
        <el-col :span="4">
          <el-form-item prop="ageRange2">
            <el-input v-model="form.ageRange2" type='number' style="width: 150px;"  min="0" placeholder="输入最大人数"></el-input>
      ...
      <el-form-item label="培训类别" prop="category" required>
        <el-select v-model="form.category" placeholder="选择培训类别" style="width: 150px;">
          ...
          <el-option label="游泳" value="lanqiu"></el-option>
          <el-option label="舞蹈类" value="zuqiu"></el-option>
      ...
      <el-form-item label="报名费用">
        <el-col :span="24" style="border: 1px solid #DCDCDC">
          ...
          >
            ...
            <el-col :span="4" >
              <div id="domains">
                ...
                <el-select v-model="domain.unit" style="width:80px" label="" placeholder=" " :key="Math.random()" id="select">
                  <el-option label="课时" value="课时" :key="Math.random()"></el-option>
                  <el-option label="周" value="周" :key="Math.random()"></el-option>
                  <el-option label="月" value="月" :key="Math.random()"></el-option>
                  <el-option label="季" value="季" :key="Math.random()"></el-option>
                  <el-option label="半年" value="半年" :key="Math.random()"></el-option>
                  <el-option label="年" value="年" :key="Math.random()"></el-option>
                </el-select>
              </div>
            </el-col>
            <el-col :span="4">
        ...
        <el-col :span="24"  style="margin-top:20px">
          <el-form-item>
            <el-button @click="addDomain()">新增费用</el-button>
          </el-form-item>
        </el-col>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      toAddress () {
        ...
        var val = this.form.cityRange + this.form.areaRange + this.form.streetRange
      ...
      createTrains () {
        ...
        var para = {
          ...
          // 开始日期
          start_date: _this.form.date1,
          //  结束日期
          end_date: _this.form.date2,
          // 每天开始时间 可选
          start_time: '',
          // 每天结束时间 可选
          end_time: '',
